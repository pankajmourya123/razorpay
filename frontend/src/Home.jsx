...
const Home = () => {
    ...
    const checkoutHandler = async (amount) => {
        ...
        const { data: { key } } = await axios.get("http://www.localhost:9000/api/getkey")
        ...
        const options = {
            ...
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRR5o-Wht1f_dcEUu_sCN-Qy9kBx3cMDMz5fEQgVcBzEw&s",
            order_id: order.id,
